...
import Intrests from "@/components/server/intrests";
...
export default function Home() {
  ...
  const handleYesButtonClick = () => {
    ...
    removeClass( "hide","intrestsContainer");
    scrollToId("intrestsContainer");
    setTimeout(() => {
    ...
    <main className="main" style = {{overflow: 'hidden'}}>
      ...
      */}
      <section id="welcomeContainer" className = "container welcomeContainer">
        <div id="welcome" className="wrapper welcomeWrapper welcome" style={{paddingTop: '10vw'}}>
      ...
      */}
      ...
      {/*
        Recomendation page
      */}
      <section id="recomendationContaier" className = "container recomendationContainer hide">
			...
			<button className="getRecommendationButton answerButton" onClick={handleGetRecommendationButtonClick}>Get recommendations!</button>
      </section>
    </main>
  );
};
...
/*
  <div className="mainWrapper welcome" style={{paddingTop: '10vw'}}>
    <div className="answers" style={{marginTop: '10vw', opacity: '0'}}>
        <p className="user">Här finns det text</p>
    </div>
  </div>
*/